      ...
      <div className={cl.carousel}>
        ...
        <div className={cl.cards}>
          <label className={cl.card_1} htmlFor="item-1" id="card-1">
            <Image priority width={500} height={500} src={imgs[0].url} alt={alt || ""} />
          </label>
          <label className={cl.card_2} htmlFor="item-2" id="card-2">
            <Image width={500} height={500} src={imgs[1].url} alt={alt || ""} />
          </label>
          <label className={cl.card_3} htmlFor="item-3" id="card-3">
            <Image width={500} height={500} src={imgs[2].url} alt={alt || ""} />
          </label>
        </div>
      </div>
    </>
